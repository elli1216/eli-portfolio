...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    if (isMobile || !cornersRef.current || !dotRef.current) return;
    const activeColor = isActiveRef.current ? (cursorColorOnTarget || cursorColor) : cursorColor;
    gsap.to(Array.from(cornersRef.current), {
  ...
  }, [cursorColor, cursorColorOnTarget, isMobile]);
